package codenevisha.ir.app.journey.util.helper
...
object LocaleHelper {
    ...
    fun onAttach(context: Context?, defaultLanguage: String): Context? {
        ...
        return if (context == null) context else setLocale(context, lang)
    }
    ...
    private fun setLocale(context: Context?, language: String?): Context? {
        ...
        return when {
            context == null -> null
            Build.VERSION.SDK_INT >= Build.VERSION_CODES.N -> updateResources(context, language)
